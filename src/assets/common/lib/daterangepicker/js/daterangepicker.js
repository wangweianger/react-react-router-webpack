...
*/
    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function() {
            // var input=this.element.find('.reservation-text')
            // if (input.is('input') && !this.singleDatePicker) {
            //     input.val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
            // } else if (input.is('input')) {
            //     input.val(this.startDate.format(this.format));
            // }
        },
